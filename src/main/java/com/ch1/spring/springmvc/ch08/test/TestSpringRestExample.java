package com.ch1.spring.springmvc.ch08.test;

import com.ch1.spring.springmvc.ch08.controller.EmpRestURIConstants;
...
public class TestSpringRestExample {
    ...
    public static void printEmpData(Employee emp) {
        System.out.println("ID=" + emp.getId() + ",Name=" + emp.getName() + ",CreatedDate=" + emp.getCreateDate());
    }
}
